...
public class LoiMhCalcul {
    ...
    public ResultatMhDTO calculerLoiMh(ProduitImmobilierDTO produitImmobilierDTO, Integer dureeCredit, double taeg, double revenus, boolean estCouple, int nbrEnfants){
        ...
        resultatMhDTO.setEconomyImpotsInvest(calculerEconomyImpots(infoTmiInv.getImpots() ,produitImmobilierDTO.getCoutTravaux() * infoTmiInv.getTmi(),
                dureeCredit, true , resultatMhDTO));
        ...
        resultatMhDTO.setMoyenneEffortEpargneInvest(resultatMhDTO.getMensualiteCredit()
                - resultatMhDTO.getEconomyImpotsInvest()/dureeCredit - produitImmobilierDTO.getLoyerEstime());

        resultatMhDTO.setMoyenneEffortEpargneHabit(resultatMhDTO.getMensualiteCredit()
                - resultatMhDTO.getEconomyImpotsHabit()/dureeCredit - produitImmobilierDTO.getLoyerEstime());
